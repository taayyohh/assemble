...
contract DeploymentIntegrationTest is Test {
    ...
    function test_RealWorldEventScenario() public {
        ...
        uint256 ticket2 = assemble._generateTokenId(Assemble.TokenType.EVENT_TICKET, eventId, 1, 1);
        uint256 ticket3 = assemble._generateTokenId(Assemble.TokenType.EVENT_TICKET, eventId, 2, 1);
        ...
        uint256 credId = assemble._generateTokenId(Assemble.TokenType.ORGANIZER_CRED, eventId, 0, 0);
        ...
        uint256 badgeId = assemble._generateTokenId(Assemble.TokenType.ATTENDANCE_BADGE, eventId, 0, 0);
    ...
    function _createStandardEvent() internal returns (uint256 eventId) {
        ...
        splits[0] = Assemble.PaymentSplit(organizer, 10000, "organizer");
