...
contract SecurityTests is Test {
    ...
    function test_CannotDrainProtocolFunds() public {
        ...
        vm.prank(attacker);
        vm.expectRevert(abi.encodeWithSignature("NoFundsToClaim()"));
    ...
    function test_CannotBypassTicketLimits() public {
        ...
        vm.prank(attacker);
        vm.expectRevert(abi.encodeWithSignature("InsufficientCapacity()"));
    ...
    function test_CannotCreateEventWithInvalidSplits() public {
        ...
        zeroSplits[0] = Assemble.PaymentSplit(address(0), 10_000, "zero");
    ...
    function test_CannotCreateEventWithInvalidTiming() public {
        ...
        vm.prank(alice);
        vm.expectRevert(abi.encodeWithSignature("InvalidFutureTime()"));
