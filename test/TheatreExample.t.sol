...
contract TheatreExampleTest is Test {
    ...
    function test_TheatreProduction() public {
        ...
        uint256 castCrewEarnings = (netRevenue * 4000) / 10000;
        uint256 directorEarnings = (netRevenue * 2000) / 10000;
        ...
        uint256 ticket1 = assemble._generateTokenId(Assemble.TokenType.EVENT_TICKET, eventId, 1, 1);
        vm.prank(theatergoer1);
